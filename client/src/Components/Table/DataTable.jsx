...
function DataTable() {
    ...
    const [numItemsCartMsg, setNumItemsCartMsg] = useState(`You have ${cartItems.length} items in your cart.`);
    ...
    function updateCart() {
        ...
        setNumItemsCartMsg(numItemsMsg);
    ...
    function searchProducts() {
        const itemSearchField = document.getElementById("item-search");
    }
        ...
        <div>
            <div className='container'>
                ...
                <div className='cart-interface'>
                    <h1>Cart</h1>
                    <p id='num-items-msg'>{numItemsCartMsg}</p>
                    <br/>
